...
<body>
  ...
  <a href="http://localhost/435project/contact.php">Contact</a>
	...
	<form action = "" method = "post">
		...
		<div>
					<input type = "submit" name="pickup" value = "Submit" > <!-- Submit button-->
		</div>
	</form>
		<div></div>
	...
	else
	{
			...
			if ($_SERVER["REQUEST_METHOD"] == "POST")
			{
				...
				else
				{
					...
					$sql = "SELECT Station_available FROM station where Station_id = '$station';"; //get station availibility
					$result = $conn->query($sql);
					//$transactionid = "";
					$stationavail = "";
					if ($result->num_rows > 0) 
								...
								if(mysqli_query($conn, $sql))
								{
									//echo "<p> Test2 </p> ";
										...
										//echo "<p> Test4 </p> ";
											...
											<a href = 'http://localhost/435project/payment.php'> <button> Go to Payment </button> </a> "
											;
