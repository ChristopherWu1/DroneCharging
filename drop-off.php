...
<h1> Input your Credentials: </h1>
		...
		<form action = "" method = "post">
				...
				<div>
					<label> Please Insert a 4-digit pin number. We will ask for it at drone pickup: </label>
				...
				<select name="drone" style="height:30px;">
					...
					<option value="Mavic Mini 2">Mavic Mini 2
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 1 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
									while($row = $result->fetch_assoc()) 
									{
									echo " Dimensions: " . $row["drone_length"].  "X" . $row["drone_width"]. "X" . $row["drone_height"];
									}
								}
							}
					...
					<option value="Mavic Pro 2">Mavic Pro 2
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 2 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
					...
					<option value="Mavic Air 2">Mavic Air 2
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 3 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
					...
					<option value="Parrot Anafi">Parrot Anafi
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 4 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
					...
					<option value="Mavic 2 Zoom">Mavic 2 Zoom
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 5 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
					...
					<option value="Ryze Tello">Ryze Tello
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 6 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
					...
					<option value="Phantom 4 Pro V2.0">Phantom 4 Pro V2.0
							<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 7 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
					...
					<option value="Inspire 2"> Inspire 2
					<?php 
							$servername = "localhost";
							$username = "root";
							$password = "";
							...
							{
								//echo '<p>Connected successfully</p>';
								$sql = "Select drone_length,drone_width,drone_height from drone where drone_id = 8 ";
								$result = $conn->query($sql);
								if ($result->num_rows > 0) 
								{
									// output data of each row
